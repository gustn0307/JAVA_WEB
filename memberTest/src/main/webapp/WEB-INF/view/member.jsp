						...
						<form action="member-reg" method="post" >
									...
									<tr>
										...
										<td class="birth">
											<div class="flex center">
												<input name="year" type="text" size="4" maxlength="4" pattern="[0-9]{4}" placeholder="YYYY"><span>/</span>
												<input name="month" type="text" size="2" maxlength="2" pattern="[0-9]{2}" placeholder="MM"><span>/</span>
												<input name="day" type="text" size="2" maxlength="2" pattern="[0-9]{2}" placeholder="DD">
											</div>
										</td>
										<td><!-- 버튼없음 --></td>
									</tr>
							...
							<div class="flex" id="terms">
								...
								<ul class="check-items">
									...
									<li>
										<dl class="flex">
											<dt><input type="checkbox" name="private2" value="t"></dt>
											<dd class="flex between">
										...
										<dl class="flex">
											...
											<dd >
												...
												<div class="sms-email">
													...
													<span class="check-email">
														<input type="checkbox" name="mailling" value="t" >
														<label>이메일</label>
													</span>
												</div>
												<p class="guide sms">
